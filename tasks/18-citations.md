...
**Acceptance criteria:**
- [x] `done` event includes `[{document_id, filename, chunk_preview}]`
- [x] Sources persisted in `messages.sources` JSONB
- [x] `SourceList` renders under each assistant answer, including on history reload

**Verification:**
- [x] Every grounded answer shows which documents it came from
