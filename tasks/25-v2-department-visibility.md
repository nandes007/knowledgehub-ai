...
**Acceptance criteria:**
- [x] Upload accepts department/visibility; stored in DB + chunk metadata
- [x] Retrieval filters with Chroma `where` by user's role/department
- [x] UI selector on upload; user in dept A never retrieves dept-B-only docs

**Verification:**
- [x] Two users, two departments: cross-department questions return nothing from the other's docs
