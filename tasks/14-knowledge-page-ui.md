...
**Acceptance criteria:**
- [ ] Drag-and-drop or click-to-upload works for PDF/DOCX/PPTX/MD
- [ ] Table shows filename, status, uploaded date; status polls until `ready`/`failed`
- [ ] Delete asks for confirmation, then removes the row

**Verification:**
- [ ] Upload in browser → watch status flip to *ready* → doc appears in table
